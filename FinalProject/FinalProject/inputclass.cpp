...
int InputClass::Check()
{
	...
	else if (m_keyboardState[DIK_LSHIFT] & 0x80)
	{
		return 9;
	}
...
bool InputClass::CheckSpaceState()
{
	...
	else if (!m_keyboardState[DIK_SPACE])
	{
		return false;
	}
}
...
void InputClass::SetMouseLocation(int mouseX, int mouseY)
{
	m_mouseX = mouseX;
	m_mouseY = mouseY;
	return;
